      ...
      <div className="dashboard-content">
          ...
          <div className="child-details">
            ...
            <div className="progress-chart">
              ...
              <div className="chart-bars">
                {[1, 2, 3, 4, 5].map(phase => {
                    // Generate stable random values based on phase or just use fixed mock data
                    const randomVal = (phase * 17) % 100; 
                    return (
                  <div key={phase} className="chart-bar">
                    ...
                    <div className="bar-value">{randomVal}%</div>
                  </div>
                )})}
              </div>
            </div>
        ...
        <div className="parental-controls">
          ...
          <div className="control-group">
            <label htmlFor="maxTime">Tempo máximo diário (minutos):</label>
            <input
              id="maxTime"
              type="number"
          ...
          <div className="control-group">
            <label htmlFor="maxDiff">Dificuldade máxima permitida:</label>
            <select
              id="maxDiff"
          ...
          <div className="control-group">
            <label htmlFor="pin">PIN de controle parental:</label>
            <input
              id="pin"
              type="password"
